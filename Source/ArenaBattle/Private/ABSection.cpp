...
AABSection::AABSection()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_SQAURE(*AssetPath);
	if (SM_SQAURE.Succeeded())
	{
		Mesh->SetStaticMesh(SM_SQAURE.Object);
	}
	else
	{
	...
	Trigger->OnComponentBeginOverlap.AddDynamic(this, &AABSection::OnTriggerBeginOvelap);
...
void AABSection::SetState(ESectionState NewState)
{
	...
	case ESectionState::BATTLE:
		...
		GetWorld()->GetTimerManager().SetTimer(SpawnNPCTimerHandle, FTimerDelegate::CreateUObject(this,
			&AABSection::OnNPCSpawn), EnemySpawnTime, false);
...
void AABSection::OnTriggerBeginOvelap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
